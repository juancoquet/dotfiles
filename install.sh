...
remove_managed_link "$HOME/.pi/agent/agents/researcher.md" "$GENERATED_AGENTS/pi/agents/researcher.md"
remove_managed_link "$HOME/.claude/agents/researcher.md" "$GENERATED_AGENTS/claude/agents/researcher.md"
remove_managed_link "$HOME/.codex/agents/researcher.toml" "$GENERATED_AGENTS/codex/agents/researcher.toml"
remove_managed_link "$HOME/.cursor/agents/researcher.md" "$GENERATED_AGENTS/cursor/agents/researcher.md"
remove_managed_link "$HOME/.config/opencode/agent/researcher.md" "$GENERATED_AGENTS/opencode/agent/researcher.md"

link_managed "$GENERATED_AGENTS/pi/agents/branch-reviewer.md" "$HOME/.pi/agent/agents/branch-reviewer.md"
link_managed "$GENERATED_AGENTS/pi/agents/primary-source-researcher.md" "$HOME/.pi/agent/agents/primary-source-researcher.md"
link_managed "$GENERATED_AGENTS/claude/agents/branch-reviewer.md" "$HOME/.claude/agents/branch-reviewer.md"
link_managed "$GENERATED_AGENTS/claude/agents/primary-source-researcher.md" "$HOME/.claude/agents/primary-source-researcher.md"
link_managed "$GENERATED_AGENTS/codex/agents/branch-reviewer.toml" "$HOME/.codex/agents/branch-reviewer.toml"
link_managed "$GENERATED_AGENTS/codex/agents/primary-source-researcher.toml" "$HOME/.codex/agents/primary-source-researcher.toml"
link_managed "$GENERATED_AGENTS/cursor/agents/branch-reviewer.md" "$HOME/.cursor/agents/branch-reviewer.md"
link_managed "$GENERATED_AGENTS/cursor/agents/primary-source-researcher.md" "$HOME/.cursor/agents/primary-source-researcher.md"
...
link_managed "$GENERATED_AGENTS/opencode/agent/primary-source-researcher.md" "$HOME/.config/opencode/agent/primary-source-researcher.md"
